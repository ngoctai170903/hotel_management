...
import GUI.service.ServiceDialog;
import DTO.Service;
...
public class ServiceDialog extends javax.swing.JDialog {
 private boolean editMode = false;
    ...
    public Service openForEdit(Service s) {
        editMode = true;
        currentService = s;
    ...
    private void chkActiveActionPerformed(java.awt.event.ActionEvent evt) {                                          
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {                                        
      if (!validateForm()) return;
        ...
        if (editMode && currentService != null) {
            ...
            resultService = new Service(0, name, unit, price, type, active);
        }
        dispose();
    }                                       
